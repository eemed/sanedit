...
//
//   ucd-generate grapheme-cluster-break /tmp/ucd-15.0.0 --chars
//
...
pub const CONTROL: &'static [(char, char)] = &[
  ('\0', '\t'), ('\u{b}', '\u{c}'), ('\u{e}', '\u{1f}'), ('\u{7f}', '\u{9f}'),
  ('\u{ad}', '\u{ad}'), ('\u{61c}', '\u{61c}'), ('\u{180e}', '\u{180e}'),
  ('\u{200b}', '\u{200b}'), ('\u{200e}', '\u{200f}'),
  ('\u{2028}', '\u{202e}'), ('\u{2060}', '\u{206f}'),
  ('\u{feff}', '\u{feff}'), ('\u{fff0}', '\u{fffb}'),
...
pub const EXTEND: &'static [(char, char)] = &[
  ...
  ('\u{cbf}', '\u{cbf}'), ('\u{cc2}', '\u{cc2}'), ('\u{cc6}', '\u{cc6}'),
  ('\u{ccc}', '\u{ccd}'), ('\u{cd5}', '\u{cd6}'), ('\u{ce2}', '\u{ce3}'),
  ...
  ('\u{11839}', '\u{1183a}'), ('\u{11930}', '\u{11930}'),
  ...
  ('\u{16fe4}', '\u{16fe4}'), ('\u{1bc9d}', '\u{1bc9e}'),
  ...
  ('\u{1e4ec}', '\u{1e4ef}'), ('\u{1e8d0}', '\u{1e8d6}'),
...
pub const PREPEND: &'static [(char, char)] = &[
  ...
  ('\u{890}', '\u{891}'), ('\u{8e2}', '\u{8e2}'), ('ൎ', 'ൎ'),
  ('\u{110bd}', '\u{110bd}'), ('\u{110cd}', '\u{110cd}'), ('𑇂', '𑇃'),
  ('𑤿', '𑤿'), ('𑥁', '𑥁'), ('𑨺', '𑨺'), ('𑪄', '𑪉'),
  ('𑵆', '𑵆'), ('𑼂', '𑼂'),
];
