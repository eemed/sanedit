...
pub enum ThemeField {
    ...
    FiletreeSelectedError,
    FiletreeSelectedSymlink,
...
impl AsRef<str> for ThemeField {
    fn as_ref(&self) -> &str {
        ...
        match self {
            ...
            FiletreeSymlink => "filetree.symlink",
            FiletreeSelected => "filetree.selected",
            FiletreeSelectedFile => "filetree.selected.file",
            FiletreeSelectedError => "filetree.selected.error",
            FiletreeSelectedSymlink => "filetree.selected.symlink",
            ...
            SnapshotsLastSaved => "snapshots.saved",
            SnapshotsSelected => "snapshots.selected",
            SnapshotsSelectedLastSaved => "snapshots.selected.saved",
